...
frame_entrada_clientes = tk.LabelFrame(frame_clientes, text="Registrar nuevo cliente", font=("Arial", 12, "bold"), bg=COLOR_CARD)
frame_entrada_clientes.pack(fill=tk.X, padx=10, pady=10)

tk.Label(frame_entrada_clientes, text="Cédula:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(10, 0))
...
tk.Label(frame_entrada_clientes, text="Nombre completo:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(0, 0))
...
tk.Label(frame_entrada_clientes, text="Correo electrónico:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(0, 0))
...
frame_tabla_clientes = tk.LabelFrame(frame_clientes, text="Clientes registrados", font=("Arial", 12, "bold"), bg=COLOR_CARD)
...
frame_config_servicio = tk.LabelFrame(frame_reservas, text="Configurar servicio", font=("Arial", 12, "bold"), bg=COLOR_CARD)
frame_config_servicio.pack(fill=tk.X, padx=10, pady=10)

tk.Label(frame_config_servicio, text="Tipo de servicio:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(10, 0))
...
tk.Label(frame_config_servicio, text="Nombre:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10)
...
tk.Label(frame_config_servicio, text="Precio base ($):", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10)
...
label_duracion_servicio = tk.Label(frame_config_servicio, text="Duración (horas):", font=("Arial", 10, "bold"), bg=COLOR_CARD)
...
label_especialista = tk.Label(frame_config_servicio, text="Especialista:", font=("Arial", 10, "bold"), bg=COLOR_CARD)
...
frame_nueva_reserva = tk.LabelFrame(frame_reservas, text="Crear nueva reserva", font=("Arial", 12, "bold"), bg=COLOR_CARD)
frame_nueva_reserva.pack(fill=tk.X, padx=10, pady=10)

tk.Label(frame_nueva_reserva, text="Seleccionar cliente:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(10, 0))
...
frame_tabla_reservas = tk.LabelFrame(frame_reservas, text="Reservas confirmadas", font=("Arial", 12, "bold"), bg=COLOR_CARD)
...
frame_busqueda_clientes = tk.LabelFrame(frame_busqueda, text="Buscar cliente por cédula", font=("Arial", 12, "bold"), bg=COLOR_CARD)
frame_busqueda_clientes.pack(fill=tk.X, padx=10, pady=10)

tk.Label(frame_busqueda_clientes, text="Ingresa la cédula:", font=("Arial", 10, "bold"), bg=COLOR_CARD).pack(anchor=tk.W, padx=10, pady=(10, 0))
...
frame_comentarios = ttk.Frame(notebook, bg=COLOR_FONDO)
